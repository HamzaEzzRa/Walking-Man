	...
	namespace Databases
	{
		std::unordered_map<std::string, FunctionData> functionDatabase =
		{
			...
			},
			{
				...
				{"WwiseRTPCStateActivate",
				"4D 85 C0 0F 84 ?? ?? ?? ?? 57 41 54 41 56 41 57 48 83 EC ?? 48 89 5C 24 50 "
				"49 8B F8 48 89 6C 24 58 4C 8B E2 48 89 74 24 60 4C 8B F9 4C 89 6C 24 20 45 "
				"33 F6 0F 1F 40 00 0F 1F 84 00 00 00 00 00 45 8B EE 4C 0F A3 EF 0F 83 ?? ?? "
				"?? ?? 41 8B 4F 20 85 C9 0F 84 ?? ?? ?? ?? 33 D2 43 8D 04 34 F7 F1 49 8B 47 "
				"18 48 8B 2C D0 48 85 ED 74 ?? 66 90 4C 39 65 00 75 ?? 44 39 75 08 74 ?? 48 "
				"8B 6D 10 48 85 ED 75 ?? 33 ED 48 85 ED 0F 84 ?? ?? ?? ?? 48 8B 5D 50 8B 45 "
				"58 48 C1 E0 05 48 03 C3 48 3B D8 0F 84 ?? ?? ?? ?? 41 8B 4F 08 85 C9 74 ?? "
				"44 8B 43 04 33 D2 49 8B 37 41 8B C0 F7 F1 48 8B 34 D6 48 85 F6 74 ?? 44 39 "
				"06 74 ?? 48 8B 76 08 48 85 F6 75 ?? EB ?? 48 85 F6 74 ?? 48 8B 46 60",
				// gp version (same)
				"4D 85 C0 0F 84 ?? ?? ?? ?? 57 41 54 41 56 41 57 48 83 EC ?? 48 89 5C 24 50 "
				"49 8B F8 48 89 6C 24 58 4C 8B E2 48 89 74 24 60 4C 8B F9 4C 89 6C 24 20 45 "
				"33 F6 0F 1F 40 00 0F 1F 84 00 00 00 00 00 45 8B EE 4C 0F A3 EF 0F 83 ?? ?? "
